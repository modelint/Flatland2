"""
connector_name_spec_instances.py
"""
...
population = [
    ...
    {'Connector type': 'generalization', 'Diagram type': 'class', 'Notation': 'xUML',
     'Vertical axis buffer': 11, 'Horizontal axis buffer': 11, 'Default name': 'Rxx', 'Optional': False},

    {'Connector type': 'binary association', 'Diagram type': 'class', 'Notation': 'Shlaer-Mellor',
     'Vertical axis buffer': 11, 'Horizontal axis buffer': 11, 'Default name': 'Rxx', 'Optional': False},
    {'Connector type': 'generalization', 'Diagram type': 'class', 'Notation': 'Shlaer-Mellor',
     'Vertical axis buffer': 11, 'Horizontal axis buffer': 11, 'Default name': 'Rxx', 'Optional': False},
]