...
def define(db) -> dict:
    ...
    return {
        ...
        'connector_name_spec': Table('Connector Name Spec', db.MetaData,
        ...
        'stem_name_spec': Table('Stem Name Spec', db.MetaData,
                                ...
                                Column('Default name', String, nullable=False),
                                Column('Optional', Boolean, nullable=False),
                                PrimaryKeyConstraint('Stem type', 'Diagram type',
                                                     'Notation', 'End', name='I1'),
                                ForeignKeyConstraint(('Diagram type', 'Notation'),
                                                     ['Diagram Notation.Diagram type',
                                                      'Diagram Notation.Notation'],
                                                     name='R72_diag_notation'),
                                ForeignKeyConstraint(('Stem type', 'Diagram type'),
                                                     ['Stem Type.Name',
